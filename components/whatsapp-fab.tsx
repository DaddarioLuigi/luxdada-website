...
const WHATSAPP_HREF = "https://wa.me/393924842124"
...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed z-[55] bottom-6 right-6 group"
    >
      <div className="relative h-14 w-14 !rounded-full bg-[#25D366] shadow-xl flex items-center justify-center hover:scale-105 transition-transform cursor-pointer text-white ring-2 ring-white">
        ...
        <span className="absolute -top-8 right-0 whitespace-nowrap text-xs font-medium bg-[#293e72] text-white px-2 py-1 !rounded-full shadow opacity-95 group-hover:opacity-100">
          WhatsApp
        </span>
      </div>
    </a>
