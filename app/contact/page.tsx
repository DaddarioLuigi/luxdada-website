            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{isIt ? 'Email' : 'Email'}</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{isIt ? 'Telefono' : 'Phone'}</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex justify-between">
                    <span className="text-gray-600">{isIt ? 'Lunedì - Venerdì:' : 'Monday - Friday:'}</span>
                    <span className="text-gray-900">09:00 - 18:00</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-600">{isIt ? 'Sabato:' : 'Saturday:'}</span>
                    <span className="text-gray-900">10:00 - 14:00</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-600">{isIt ? 'Domenica:' : 'Sunday:'}</span>
                    <span className="text-gray-900">{isIt ? 'Chiuso' : 'Closed'}</span>
                  </li>
                </ul>
              </div>
            </motion.div>
                ...
                <CardContent className="p-8">
                  {isSubmitted ? (
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">{isIt ? 'Grazie!' : 'Thank You!'}</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">{isIt ? 'Scrivici un messaggio' : 'Send Us a Message'}</h3>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label htmlFor="name" className="text-sm font-medium text-gray-700">
                            {isIt ? 'Nome e cognome' : 'Full Name'} <span className="text-red-500">*</span>
                          </label>
                          <Input
                            id="name"
                            name="name"
                            ...
                            placeholder={isIt ? 'Mario Rossi' : 'John Doe'}
                            required
                        ...
                        <div className="space-y-2">
                          <label htmlFor="email" className="text-sm font-medium text-gray-700">
                            {isIt ? 'Indirizzo email' : 'Email Address'} <span className="text-red-500">*</span>
                          </label>
                          <Input
                            id="email"
                            name="email"
                            ...
                            onChange={handleChange}
                            placeholder={isIt ? 'mario@esempio.com' : 'john@example.com'}
                            required
                            className="border-gray-300 focus:border-[#293e72] focus:ring-[#293e72]"
                          />
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label htmlFor="company" className="text-sm font-medium text-gray-700">
                            {isIt ? 'Nome azienda' : 'Company Name'}
                          </label>
                          <Input
                            id="company"
                            name="company"
                            ...
                            onChange={handleChange}
                            placeholder={isIt ? 'La tua azienda' : 'Your Company'}
                            className="border-gray-300 focus:border-[#293e72] focus:ring-[#293e72]"
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          <label htmlFor="phone" className="text-sm font-medium text-gray-700">
                            {isIt ? 'Numero di telefono' : 'Phone Number'}
                          </label>
                          <Input
                            id="phone"
                            name="phone"
                            ...
                            onChange={handleChange}
                            placeholder={isIt ? '+39 345 123 4567' : '+1 (555) 123-4567'}
                            className="border-gray-300 focus:border-[#293e72] focus:ring-[#293e72]"
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <label htmlFor="interest" className="text-sm font-medium text-gray-700">
                          {isIt ? 'Mi interessa' : "I'm interested in"} <span className="text-red-500">*</span>
                        </label>
                        <Select required onValueChange={handleSelectChange} defaultValue={formState.interest}>
                          <SelectTrigger className="border-gray-300 focus:border-[#293e72] focus:ring-[#293e72]">
                            <SelectValue placeholder={isIt ? 'Seleziona un’opzione' : 'Select an option'} />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="space-y-2">
                        <label htmlFor="message" className="text-sm font-medium text-gray-700">
                          {isIt ? 'Messaggio' : 'Message'} <span className="text-red-500">*</span>
                        </label>
                        <Textarea
                          id="message"
                          name="message"
                          ...
                          onChange={handleChange}
                          placeholder={isIt ? 'Raccontaci del tuo progetto o della tua richiesta…' : 'Tell us about your project or inquiry...'}
                          required
                          rows={5}
                          className="border-gray-300 focus:border-[#293e72] focus:ring-[#293e72]"
                        />
                      ...
                      <Button type="submit" className="bg-[#293e72] hover:bg-[#1e2e57] text-white w-full py-6">
                        {isIt ? 'Invia messaggio' : 'Send Message'} <Send className="ml-2 h-4 w-4" />
                      </Button>
                    </form>
                  )}
                </CardContent>
            ...
            {(isIt
              ? [
                  ...
                  },
                  {
                    ...
                    answer:
                      'Dipende da ambito e complessità. Un progetto piccolo può richiedere 4–8 settimane, iniziative più ampie 3–6 mesi o oltre. Forniamo una timeline dettagliata già dalla prima consulenza.',
                  },
                  {
                    question: 'Offrite supporto continuativo dopo il go‑live?',
                    answer:
                      'Sì, forniamo supporto e manutenzione post‑implementazione. Disponiamo di pacchetti dedicati per garantire performance ottimali e un’evoluzione continua delle soluzioni.',
                  },
                  {
